...
func (a *OpenTracingAppLayer) GetUserCategoryUsage(dimensions []string, startTime time.Time, endTime time.Time) []*app.AWSMeterReport {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.GetUserCategoryUsage")
	...
	defer span.Finish()
	resultVar0 := a.app.GetUserCategoryUsage(dimensions, startTime, endTime)
...
func (a *OpenTracingAppLayer) NewAWSMeterService() (*app.AWSMeterService, error) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.NewAWSMeterService")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.NewAWSMeterService()
...
func (a *OpenTracingAppLayer) ReportUserCategoryUsage(ams *app.AWSMeterService, reports []*app.AWSMeterReport) *model.AppError {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.ReportUserCategoryUsage")
	...
	defer span.Finish()
	resultVar0 := a.app.ReportUserCategoryUsage(ams, reports)
...
func (a *OpenTracingAppLayer) SendReportToMeteringService(ams *app.AWSMeterService, report *app.AWSMeterReport) *model.AppError {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.SendReportToMeteringService")
	...
	defer span.Finish()
	resultVar0 := a.app.SendReportToMeteringService(ams, report)
